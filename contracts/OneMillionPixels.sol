...
import "./SimpleERC721.sol";
  	...
  	/**
	 * @title OneMillionPixels
	 *
	 * A script that manages 10 000 tokens that represents a square of 10*10 colored pixels
	*/

contract OneMillionPixels is SimpleERC721 {

    // -----------------------------------------------------------------------------------------------------------
    // ------------------------------------------------ Variables ------------------------------------------------
    // ----------------------------------------------------------------------------------------------------------- 

    string public name = "Hundred Pixels";
    string public symbol = "HPs";
    ...
    function OneMillionPixels() public {
        owner = msg.sender;
    }
    ...
    function initialBuyToken (uint _tokenId) payable public onlyNonexistentToken (_tokenId) {
        ...
        EmitBought(_tokenId, msg.value, msg.sender);
    }
    ...
    function setTokenPixelsColors (uint _tokenId, string _newColors) public onlyExtantToken (_tokenId) onlyOwnerOfToken (_tokenId) {
        ...
        EmitChangedPixelsColors(_tokenId);
    }
    ...
    function setTokenDescription (uint _tokenId, string _newDescription) public onlyExtantToken (_tokenId) onlyOwnerOfToken (_tokenId) {
        ...
        EmitChangedDescription(_tokenId);
    }
